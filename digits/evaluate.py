"""
Stage 4b - Evaluation script for the digit model. Mirrors src/evaluate.py.

Run from the project root:
    python -m digits.evaluate
"""
import time
...
def main():
    ...
    if not test_samples:
        raise RuntimeError("Test split is empty. Check that digits/data/commands/ is populated.")
    test_ds = DigitCommandDataset(test_samples, augment=False)
